                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="details" class="form-control" required placeholder="Enter product details" rows="4"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
            ...
            <div class="card">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <input type="text" id="productSearch" class="form-control" placeholder="Search Product..." style="width: 250px;">
