                                ...
                                @if ($addresses->count() > 0)
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="use_manual_address"
                                                name="use_manual_address">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="method" id="method"
                                    ...
                                    <option value="credit_card" {{ old('method') == 'credit_card' ? 'selected' : '' }}>
                                        Credit Card</option>
                                    <option value="paypal" {{ old('method') == 'paypal' ? 'selected' : '' }}>PayPal
                                    </option>
                                    <option value="cash_on_delivery"
                                        {{ old('method') == 'cash_on_delivery' ? 'selected' : '' }}>Cash on Delivery
                                    </option>
                                </select>
                                @error('method')
                                    <div class="invalid-feedback">{{ $message }}</div>
        ...
        $(document).ready(function() {
            ...
            $("#checkoutForm").validate({
                ...
                rules: {
                    ...
                    address: {
                        required: function() {
                            return $("#use_manual_address").is(":checked") || $(
                                "select[name='address_id']").length === 0;
                        },
                        minlength: 5
                    },
                    address_id: {
