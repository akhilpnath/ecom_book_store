                                    ...
                                    <div class="col-md-3">
                                        <select class="form-select filter-select" name="sort_by">
                                            ...
                                            <option value="Price: Low to High"
                                                {{ request('sort_by') == 'Price: Low to High' ? 'selected' : '' }}>
                                                Price: Low to High
                                            </option>
                                            <option value="Price: High to Low"
                                                {{ request('sort_by') == 'Price: High to Low' ? 'selected' : '' }}>
                                                Price: High to Low
                                            </option>
                                            <option value="Newest First"
                                                {{ request('sort_by') == 'Newest First' ? 'selected' : '' }}>
                                                Newest First
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <select class="form-select filter-select" name="price_range">
                                            ...
                                            <option value="Under $200"
                                                {{ request('price_range') == 'Under $200' ? 'selected' : '' }}>Under $200
                                            </option>
                                            <option value="$200 - $500"
                                                {{ request('price_range') == '$200 - $500' ? 'selected' : '' }}>$200 - $500
                                            </option>
                                            <option value="$500 - $1000"
                                                {{ request('price_range') == '$500 - $1000' ? 'selected' : '' }}>$500 -
                                                $1000</option>
                                            <option value="$1000 - $3000"
                                                {{ request('price_range') == '$1000 - $3000' ? 'selected' : '' }}>$1000 -
                                                $3000</option>
                                            <option value="Over $3000"
                                                {{ request('price_range') == 'Over $3000' ? 'selected' : '' }}>Over $3000
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
